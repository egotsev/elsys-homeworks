...
public abstract class AbstractSerializer implements Serializer {
	...
	private boolean areIncludedNullFields;
	public AbstractSerializer(){
		spaces = 4;
		pretty = true;
		areIncludedNullFields = false;
	...
	protected int GetString(){
		return spaces;
	}
	protected void SetString(int count){
		spaces = count;
	}
	...
	@Override
	public void setPretty(boolean newPretty) {
		pretty = newPretty;
	}
