...
<path d="M150 0 L75 200 L225 200 Z" />
		*/
		cout << "M" << col_*step << " " << row_*step <<  " ";
		cout << (has_wall(DOWN)?"l":"m") << step << " " << 0 << " ";
		cout << (has_wall(RIGHT)?"l":"m") << 0 << " " << step << " ";
		cout << (has_wall(UP)?"l":"m") << -step << " " << 0 <<  " ";
		cout << (has_wall(LEFT)?"l":"m") << 0 << " " << -step << " ";
	}
...
public:
	...
	void draw(int size=10) const {
		//cout << "newpath" << endl;
		cout << "<!DOCTYPE html>\n<html>\n<body>\n";
		cout << "<svg height=\"1000\" width=\"1000\">";
		cout << "<path d=\"";
		...
		cout << " Z \" stroke=\"black\" stroke-width=\"1\" fill=\"none\"/>\n";
		cout << "Sorry, your browser does not support inline SVG.\n";
		cout << "</svg>\n";
		cout << "</body>\n</html>\n";
		//cout << "stroke" << endl;
		//cout << "showpage" << endl;
